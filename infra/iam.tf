...
# Custom policy for Athena, Glue Catalog reads, S3 results, Secrets Manager, Redshift Data API (optional)
...
data "aws_iam_policy_document" "sfn_policy" {
  ...
  statement {
    ...
    resources = [
      aws_lambda_function.athena_submit.arn,
      aws_lambda_function.redshift_copy.arn
    ]
  }
